...
pub fn correct_question(question: i32, input: &str) -> bool {
    match question {
        ...
        5  => match_exact(input, "250") || match_exact(input, "tvåhundrafemtio"),
        6  => match_exact(input, "1910") || match_exact(input, "nittontio"),
        ...
        15 => match_exact(input, "var uppmärksam på vad som händer") || match_exact(input, "var uppmarksam pa vad som hander"),
        16 => match_single_regex(input, "orange") || match_single_regex(input, "brandgul"),
        ...
        29 => match_single_regex(input, "nor") && match_single_regex(input, "polen"),
